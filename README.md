# LEGOSwarm
LEGOSwarm is an autonomous robotic assembly system that employs a [Foreman](Foreman.md) and [Workers](Worker.md) to assemble complete LEGO kits. Developed by Loom Robotics.
